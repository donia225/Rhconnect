...
from .views import OffresDuRecruteurAPIView, ajouter_offre, ajouter_suivi_carriere, candidat_profil, confirmer_embauche, deja_postule, employe_profil_et_suivi, get_candidat_id, get_candidatures_gestionnaireRH, get_suivis_employe, liste_offres, login_user, mes_candidatures, modifier_offre, modifier_suivi_carriere, register_user, request_password_reset, reset_password, supprimer_offre, update_statut_candidature, upload_cv, get_candidatures_recruteur
...
urlpatterns = [
    ...
    path('candidatures/deja-postule/<int:offre_id>/', deja_postule, name='deja_postule'),
