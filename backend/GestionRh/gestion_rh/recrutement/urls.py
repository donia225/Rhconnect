...
from .views import ajouter_offre, candidat_profil, confirmer_embauche, employe_profil_et_suivi, get_candidat_id, get_candidatures_gestionnaireRH, liste_offres, login_user, mes_candidatures, modifier_offre, register_user, request_password_reset, reset_password, supprimer_offre, update_statut_candidature, upload_cv, get_candidatures_recruteur
